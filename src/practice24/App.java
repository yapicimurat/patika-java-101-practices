...
public class App {
    ...
    static void mod(){
        ...
        System.out.print("Modu alınacak sayı sayısını giriniz:");
        int number = scan.nextInt();

        System.out.print("Mod sayısını giriniz:");
        int modNumber = scan.nextInt();

        System.out.println("Sonuç : " + number % modNumber);
    }

    static void rectangleCalculate(){
        Scanner scan = new Scanner(System.in);

        System.out.print("1-)Dikdörtgen alan hesaplama, 2-)Dikdörtgen çevre hesaplama. Seçim yapınız!");
        ...
        switch(operation){
            ...
            case 2:
                System.out.println("Dikdörtgenin çevresi: " + (shortEdge * 2 + longEdge * 2));
                break;
        }
    }
